...
public class MyUncaughtExceptionHandler implements Thread.UncaughtExceptionHandler, Serializable { // Serializable to prevent obfuscation of class and method names
  ...
  */
  ...
  private static class ReportProcessingFunction implements ProcessingFunctionI {
    ...
    private static boolean crashReport_send(final ServerInterfaceLayer SIL, long toUserId, String report) {
      ...
      try {
        ...
        TAG = TAG != null ? TAG + " " : "";
        String MSG_SUBJECT = TAG + "Crash from " + TextRenderer.getRenderedText(cache, fromUser) + " build " + GlobalProperties.PROGRAM_BUILD_NUMBER;
