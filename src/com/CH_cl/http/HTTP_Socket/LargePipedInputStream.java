...
public class LargePipedInputStream extends InputStream {
   ...
   */
  protected byte[] buffer = null;//new byte[PIPE_SIZE];
  ...
  /**
   * Creates a <code>LargePipedInputStream</code> so
   ...
   */
  public LargePipedInputStream(LargePipedOutputStream src) throws IOException {
    this(src, DEFAULT_PIPE_SIZE);
  }
  public LargePipedInputStream(LargePipedOutputStream src, int pipeSize) throws IOException {
   ...
   * connected to a <code>LargePipedOutputStream</code>
   * before being used.
   *
  ...
  public LargePipedInputStream() {
    buffer = new byte[DEFAULT_PIPE_SIZE];
  }
   ...
   * @exception  IOException  if an I/O error occurs.
   */
  public void connect(LargePipedOutputStream src) throws IOException {
    src.connect(this);
  }
