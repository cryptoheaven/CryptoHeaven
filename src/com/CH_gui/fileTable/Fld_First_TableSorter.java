...
public class Fld_First_TableSorter extends TableSorter {
  ...
  public int compareRowsByColumn (int row1, int row2, int column) {
    ...
    isFolder1 = fileType1.equals(FileTableModel.STR_FILE_FOLDER) || fileType1.equals(FileTableModel.STR_SHARED_FOLDER);
    isFolder2 = fileType2.equals(FileTableModel.STR_FILE_FOLDER) || fileType2.equals(FileTableModel.STR_SHARED_FOLDER);
