...
public class Fld_First_TableSorter extends TableSorter {
  ...
  public int compareRowsByColumn (int row1, int row2, int column) {
    ...
    int typeColumn = JSortedTable.getColumnIndex(getRawModel(), FileTableModel.STR_TYPE);
    ...
    if (model instanceof RecordTableModel) {
      ...
      isFolder1 = fileType1 != null && (fileType1.equals(FileTableModel.STR_FILE_FOLDER) || fileType1.equals(FileTableModel.STR_SHARED_FOLDER));
      isFolder2 = fileType2 != null && (fileType2.equals(FileTableModel.STR_FILE_FOLDER) || fileType2.equals(FileTableModel.STR_SHARED_FOLDER));
    }
  ...
  /* The cell is only editable if it belongs to file name column */
  public boolean isCellEditable (int row, int column) {
    boolean isEditable = false;
    // disable editing
    /*
    if (JSortedTable.getColumnIndex(getModel(), "File Name") == column) {
      isEditable = true;
    }
     **/
    return isEditable;
