...
//                  enableCopyToOutgoing = true;
  ...
  private class SendAction extends AbstractAction {
    ...
    private boolean showStagedSecureChoiceDialog(final EmailAddressRecord[] emailAddresses) {
      ...
      panel.add(new JMyLabel("Please choose from one of the following Send options:"), new GridBagConstraints(0, posY, 2, 1, 10, 0,
    ...
    for (int i=0; recipients!=null && i<recipients.length; i++) {
      ...
      if (rec instanceof EmailAddressRecord) {
        ...
        for (int k=0; addresses!=null && k<addresses.length; k++) {
          ...
          try {
            Long uID = new Long(EmailRecord.getNick(addr));
