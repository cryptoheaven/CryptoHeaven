...
public class AcceptDeclineContactDialog extends GeneralDialog {
  ...
  private void getHandle() {
    ...
    if (uRec != null) {
      ...
      jContactFrom.setIcon(uRec.getIcon());
  ...
  private void getPubKey() {
    ...
    if (kRec != null) {
      ...
      jContactEncryption.setIcon(kRec.getIcon());
      keyFetched = true;
      setEnabledButtons();
    }
    // if not found, run request to the server
  ...
  private JPanel createPanel() {
    ...
    jYourEncryption = new JMyLabel(keyRecord.plainPublicKey.shortInfo() + "/" + "AES(256)", keyRecord.getIcon(), JLabel.LEFT);
