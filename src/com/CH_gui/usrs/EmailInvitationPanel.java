...
//      actionButton.setVerticalTextPosition(JButton.CENTER);
  ...
  private class SendEmailInvitationAction extends AbstractActionTraced {
    public SendEmailInvitationAction(int actionId) {
      super(com.CH_cl.lang.Lang.rb.getString("action_Invite_Friends_and_Associates_..."), Images.get(ImageNums.MAIL_SEND_INVITE_16));
      ...
      putValue(Actions.TOOL_NAME, com.CH_cl.lang.Lang.rb.getString("actionTool_Invite_by_Email"));
    }
