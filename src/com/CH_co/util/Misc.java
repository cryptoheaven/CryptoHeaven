...
//  }
  ...
  public static String[] getEmailInvitationText(String personalMessage, String sendToEmail, UserRecord uRec) {
    String[] text = new String[2];
    if (sendToEmail == null || sendToEmail.length() == 0)
      sendToEmail = "recipient@domain.com";
    String acceptInviteURLplain = "http://www.cryptoheaven.com/ch/pickup.jsp?ai=" + sendToEmail;
    String acceptInviteURLhtml = "http://www.cryptoheaven.com/ch/pickup.jsp?ai=" + URLEncoder.encode(sendToEmail);
    String signupEmailURLplain = "http://www.cryptoheaven.com/ch/pickup.jsp?se=" + sendToEmail;
    ...
    sbPlain.append(
      ...
      "\n\n" +
      "If you are already a "+URLs.get(URLs.SERVICE_COMMUNITY_NAME)+" member, please add me to your Contact using this address "+acceptInviteURLplain+" .  Otherwise, please signup for a new account using this address "+signupEmailURLplain+" ." +
      "\n\n" +
      "Once you do so, we can communicate freely. The program is very easy to use and I highly recommend it. " +
      "\n\n" +
//      "When you join the "+URLs.get(URLs.SERVICE_NETWORK_NAME)+", create a Contact with me, my "+URLs.get(URLs.SERVICE_SOFTWARE_NAME)+" user number is " + uRec.userId.toString() + "." +
//      "\n\n" +
      "I hope to see you on "+URLs.get(URLs.SERVICE_SOFTWARE_NAME)+" soonest! " +
      "\n\n\n" +
      "Sincerely," +
      "\n" +
    ...
    sbHtml.append(
      ...
      "I would like to invite you to use "+URLs.get(URLs.SERVICE_SOFTWARE_NAME)+" if you are not already doing so.  This will allow us to exchange messages, chat or share data in utmost privacy. " +
      "</p><p>" +
      "If you are already a "+URLs.get(URLs.SERVICE_COMMUNITY_NAME)+" member, please <a href=\""+acceptInviteURLhtml+"\">add me to your Contact list</a>.  Otherwise, please <a href=\""+signupEmailURLhtml+"\">signup for a new account</a>. " +
      "</p><p>" +
      "Once you do so, we can communicate freely. The program is very easy to use and I highly recommend it. " +
      "</p><p>" +
//      "When you join the "+URLs.get(URLs.SERVICE_NETWORK_NAME)+", create a Contact with me, my "+URLs.get(URLs.SERVICE_SOFTWARE_NAME)+" user number is " + uRec.userId.toString() + "." +
