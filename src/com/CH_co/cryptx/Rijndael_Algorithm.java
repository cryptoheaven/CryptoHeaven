...
public class Rijndael_Algorithm extends Object {
    ...
    /** (ROUNDS-1) * 4 */
    private static final int limit = 14 * 4;


// Constants and variables
//...........................................................................

    public static final int BLOCK_SIZE = 16; // block size in bytes
...
//...........................................................................
     ...
     */
    public static Object makeKey(byte[] keyBytes)
    throws InvalidKeyException 
    {
        ...
        // decryption key
        int[] Kd = new int[K.length];
        System.arraycopy(K, 0, Kd, 0, K.length);
        invertKey(Kd);
...
/*
    public static byte[] blockEncrypt (byte[] in, int inOffset, Object sessionKey) {
      ...
      blockEncrypt(in, inOffset, out, 0, sessionKey);
      return out;
    }
*/
    /**
     ...
     */
    public static void blockEncrypt(byte[] in, byte[] out, Object sessionKey) {
      blockEncrypt(in, 0, out, 0, sessionKey);
    }
    public static void blockEncrypt(byte[] in, int inOffset, 
                              byte[] out, int outOffset, Object sessionKey) 
    {
        int[] K = (int[]) ((Object[]) sessionKey)[0];
...
/*
    public static byte[] blockDecrypt (byte[] in, int inOffset, Object sessionKey) {
      byte[] out = new byte[BLOCK_SIZE];
      blockDecrypt(in, inOffset, out, 0, sessionKey);
      return out;
    }
*/
    /**
     ...
     */
    public static void blockDecrypt(byte[] in, byte[] out, Object sessionKey) {
      blockDecrypt(in, 0, out, 0, sessionKey);
    }
    public static void blockDecrypt(byte[] in, int inOffset, 
                          byte[] out, int outOffset, Object sessionKey) 
    {
        int[] K = (int[]) ((Object[]) sessionKey)[1];
     ...
     */
    public static int encrypt(byte[] in, int inOffset, int inLen, 
                          byte[] out, int outOffset, Object sessionKey) {
        //int size = inLen;
        int written = 0;
        while (inLen > 0) {
            blockEncrypt(in, inOffset, out, outOffset, sessionKey);
            inOffset  += BLOCK_SIZE;
     ...
     */
    public static int decrypt(byte[] in, int inOffset, int inLen, 
                          byte[] out, int outOffset, Object sessionKey) {
        //int size = inLen;
        int written = 0;
        while (inLen > 0) {
            blockDecrypt(in, inOffset, out, outOffset, sessionKey);
            inOffset  += BLOCK_SIZE;
            outOffset += BLOCK_SIZE;
            inLen     -= BLOCK_SIZE;
            written   += BLOCK_SIZE;
    ...
    private static boolean self_test (int keysize) {
        ...
        try {
            ...
            Object sessionKey = makeKey(kb);
            System.out.println("pt: " + com.CH_co.util.ArrayUtils.toString(pt));
            blockEncrypt(pt, 0, xt, 0, sessionKey);
            System.out.println("xt: " + com.CH_co.util.ArrayUtils.toString(xt));
            blockEncrypt(pt, 0, pt, 0, sessionKey);
            System.out.println("pt: " + com.CH_co.util.ArrayUtils.toString(pt));
            blockDecrypt(pt, 0, pt, 0, sessionKey);
            System.out.println("pt: " + com.CH_co.util.ArrayUtils.toString(pt));
            ...
            System.out.println("Key Gen: " + (end - start));
            ...
            for (int j=0; j<1000*1000; j++) {
              blockEncrypt(pt, 0, ct, 0, key);
            }
            end = System.currentTimeMillis();
            System.out.println("Encrypt : " + (end - start));


            start = System.currentTimeMillis();
            byte[] cpt = new byte[BLOCK_SIZE];
            for (int j=0; j<1000*1000; j++) {
              blockDecrypt(ct, 0, cpt, 0, key);
            }
            end = System.currentTimeMillis();
            System.out.println("Decrypt : " + (end - start));


            ok = java.util.Arrays.equals(pt, cpt);
            
            if (!ok)
              System.out.println("Symmetric operation failed");
        } catch (Exception x) {
          x.printStackTrace();
        }
        return ok;
