...
public class XMLElement
{
                         ...
                         boolean   ignoreCase)
    {
        ...
        this.lineNr = 0;
        Enumeration enm = this.entities.keys();
        ...
        throws IOException
    {
        ...
        if ((this.contents != null) && (this.contents.length() > 0)) {
            ...
            writer.write('>');
            Enumeration enm = this.enumerateChildren();
            while (enm.hasMoreElements()) {
                XMLElement child = (XMLElement) enm.nextElement();
                child.write(writer);
            }
            writer.write('<'); writer.write('/');
            writer.write(this.name);
    ...
    /**
     * Reverse of setNameSafe(), replace all '_' with ' '.
     */
