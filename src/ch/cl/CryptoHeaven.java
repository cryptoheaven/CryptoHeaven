...
public class CryptoHeaven extends Object {
  ...
  private static class SingletonHolder_properties {
    private static final String[][] DEFAULT_PROPERTIES = new String[][] {
      ...
      {"ToolBarModel."+com.CH_gui.contactTable.ContactTableComponent.visualsClassKeyName+"_VS_Ver1", "New Message|503|Chat|508|Create Shared Space ...|510|Find Friends and Associates ...|500|"},
