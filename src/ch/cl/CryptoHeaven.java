...
public class CryptoHeaven extends Object {
  ...
  private static class SingletonHolder_properties {
    private static final String[][] DEFAULT_PROPERTIES = new String[][] {
      ...
      {"ToolBarModel."+com.CH_gui.msgTable.MsgInboxTableComponent.visualsClassKeyName+"_VS", "New Message|729|Reply to Sender ...|707|Forward ...|705|Save Attachment(s) ...|706|Separator|0|Move ...|702|Delete ...|703|Separator|0|Mark as Unread|710|Separator|0|Search|727|Print ...|723|Add Sender to Address Book|721|Invite Sender|714|"},
