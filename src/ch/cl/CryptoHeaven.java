...
public class CryptoHeaven extends Object {
  ...
  private static class SingletonHolder_properties {
    private static final String[][] DEFAULT_PROPERTIES = new String[][] {
      ...
      {"MenuTreeModel."+com.CH_gui.frame.GroupTableFrame.visualsClassKeyName+"_VS_Ver6", "Program Menus|-1|0|(|File|-10|70|(|Add Member|312|-1|-1|-1|Separator|0|Close|800|67|67|650|)|View|-50|86|(|Table Columns ...|1202|-1|-1|-1|Sort Table By|-51|83|(|Member|1203|-1|-1|-1|Add Members|1204|-1|-1|-1|Remove Members|1205|-1|-1|-1|Separator|0|Ascending|1200|-1|-1|-1|Descending|1201|-1|-1|-1|)|)|Tools|-70|84|(|Customize Toolbar ...|101|-1|-1|-1|Customize Menus ...|102|-1|-1|-1|)|Plugins|-100000|-1|)|"},
      ...
      {"ToolBarModel."+com.CH_gui.frame.GroupTableFrame.visualsClassKeyName+"_VS_Ver6", "Add Member|312|"},
      ...
      {"ToolBarModel."+com.CH_gui.frame.MsgPreviewFrame.visualsClassKeyName+"_VS_Ver6", "Reply to Sender ...|707|Reply to All ...|722|Forward Message(s) ...|705|Save Attachment(s) ...|706|Invite Sender|714|Separator|0|Copy to Folder ...|701|Move to Folder ...|702|Delete ...|703|Separator|0|Mark as Read|709|Mark as Unread|710|Separator|0|Previous|720|Next|719|Print ...|723|"},
      {"ToolBarModel."+com.CH_gui.frame.MsgTableFrame.visualsClassKeyName+"_VS_Ver6", "Share Folder ...|312|Separator|0|New Message to Folder|700|Reply to Sender ...|707|Reply to All ...|722|Forward Message(s) ...|705|Save Attachment(s) ...|706|Invite Sender|714|Separator|0|Copy to Folder ...|701|Move to Folder ...|702|Delete ...|703|Separator|0|Mark as Read|709|Mark as Unread|710|Mark All Read|711|Search|727|Print ...|723|"},
      ...
      {"ToolBarModel."+com.CH_gui.frame.PostTableFrame.visualsClassKeyName+"_VS_Ver6", "Share Folder ...|312|Separator|0|New Message to Folder|700|Reply to Sender ...|707|Reply to All ...|722|Forward Message(s) ...|705|Save Attachment(s) ...|706|Invite Sender|714|Separator|0|Copy to Folder ...|701|Move to Folder ...|702|Delete ...|703|Separator|0|Mark All Read|711|Search|727|Print ...|723|"},
      ...
      {"ToolBarModel."+com.CH_gui.addressBook.AddressTableComponent.visualsClassKeyName+"_VS", "New Message|729|New Address to Folder|700|Compose to Address(es) ...|707|Invite by Email|714|Separator|0|Edit ...|715|Move ...|702|Delete ...|703|Separator|0|Search|727|Print ...|723|"},
      ...
      {"ToolBarModel."+com.CH_gui.contactTable.ContactTableComponent4Frame.visualsClassKeyName+"_VS_Ver2", "New Message|503|Chat|508|Separator|0|Create Shared Space ...|510|Create Group|512|Separator|0|Find Friends and Associates ...|500|Invite Friends and Associates ...|509|"},
      {"ToolBarModel."+com.CH_gui.contactTable.ContactTableComponent.visualsClassKeyName+"_VS_Ver2", "New Message|503|Chat|508|Create Shared Space ...|510|Find Friends and Associates ...|500|"},
      ...
      {"ToolBarModel."+com.CH_gui.groupTable.GroupTableComponent4Frame.visualsClassKeyName+"_VS", "Add Member|312|Separator|0|New Message To Group|1501|New Message To Member|1502|"},
      ...
      {"ToolBarModel."+com.CH_gui.msgTable.MsgDraftsTableComponent.visualsClassKeyName+"_VS", "New Message|729|New Message from Draft|718|Forward ...|705|Save Attachment(s) ...|706|Separator|0|Delete ...|703|Separator|0|Search|727|Print ...|723|"},
      {"ToolBarModel."+com.CH_gui.msgTable.MsgInboxTableComponent.visualsClassKeyName+"_VS", "New Message|729|Reply to Sender ...|707|Forward ...|705|Save Attachment(s) ...|706|Separator|0|Move ...|702|Delete ...|703|Separator|0|Mark as Unread|710|Separator|0|Search|727|Print ...|723|Invite Sender|714|"},
      {"ToolBarModel."+com.CH_gui.msgTable.MsgSentTableComponent.visualsClassKeyName+"_VS", "New Message|729|New Message from Draft|718|Forward ...|705|Save Attachment(s) ...|706|Separator|0|Move ...|702|Delete ...|703|Revoke ...|724|Separator|0|Search|727|Print ...|723|"},
      {"ToolBarModel."+com.CH_gui.msgTable.MsgSpamTableComponent.visualsClassKeyName+"_VS", "New Message|729|Reply to Sender ...|707|Forward ...|705|Save Attachment(s) ...|706|Separator|0|Move ...|702|Delete ...|703|Separator|0|Mark All Read|711|Separator|0|Search|727|Print ...|723|"},
      {"ToolBarModel."+com.CH_gui.msgTable.MsgTableComponent.visualsClassKeyName+"_VS", "New Message|729|Reply to Sender ...|707|Forward ...|705|Save Attachment(s) ...|706|Separator|0|Move ...|702|Delete ...|703|Separator|0|Mark as Unread|710|Separator|0|Search|727|Print ...|723|"},
      ...
      {com.CH_gui.frame.ChatTableFrame.visualsClassKeyName+"_VS_Ver6", "Dimension width 600 height 735 Location x 0 y 0"},
      {com.CH_gui.frame.ContactTableFrame.visualsClassKeyName+"_VS_Ver6", "Dimension width 340 height 400 Location x 0 y 0"},
      ...
      {com.CH_gui.frame.FolderTreeFrame.visualsClassKeyName+"_VS_Ver6", "Dimension width 385 height 500 Location x 0 y 0"},
      {com.CH_gui.frame.GroupTableFrame.visualsClassKeyName+"_VS_Ver6", "Dimension width 495 height 400 Location x 0 y 0"},
      ...
      {com.CH_gui.frame.MessageFrame.visualsClassKeyName+"_VS_Ver6", "Dimension width 770 height 735 Location x 0 y 0"},
      {com.CH_gui.frame.MsgPreviewFrame.visualsClassKeyName+"_VS_Ver6", "Dimension width 770 height 735 Location x 0 y 0"},
      {com.CH_gui.frame.MsgTableFrame.visualsClassKeyName+"_VS_Ver6", "Dimension width 800 height 735 Location x 0 y 0"},
      {com.CH_gui.frame.MsgTableStarterFrame.visualsClassKeyName+"_VS_Ver6", "Dimension width 800 height 735 Location x 0 y 0"},
      ...
      {com.CH_gui.frame.SubUserTableFrame.visualsClassKeyName+"_VS_Ver6", "Dimension width 800 height 400 Location x 0 y 0"},
      {com.CH_gui.frame.WhiteListTableFrame.visualsClassKeyName+"_VS_Ver6", "Dimension width 670 height 540 Location x 0 y 0"},

      {com.CH_gui.gui.JSplitPaneVS.visualsClassKeyName+"_"+com.CH_gui.table.TableComponent.visualsClassKeyName+"_"+com.CH_gui.chatTable.ChatTableComponent.visualsClassKeyName+"_VS", "Divider location 480 -1 80 0"},
      {com.CH_gui.gui.JSplitPaneVS.visualsClassKeyName+"_"+com.CH_gui.table.TableComponent.visualsClassKeyName+"_"+com.CH_gui.chatTable.ChatTableComponent4Frame.visualsClassKeyName+"_VS", "Divider location 400 -1 80 0"},
      {com.CH_gui.gui.JSplitPaneVS.visualsClassKeyName+"_"+com.CH_gui.table.TableComponent.visualsClassKeyName+"_"+com.CH_gui.msgTable.MsgDraftsTableComponent.visualsClassKeyName+"_VS", "Divider location 201 -1 35 0"},
      {com.CH_gui.gui.JSplitPaneVS.visualsClassKeyName+"_"+com.CH_gui.table.TableComponent.visualsClassKeyName+"_"+com.CH_gui.msgTable.MsgInboxTableComponent.visualsClassKeyName+"_VS", "Divider location 201 -1 35 0"},
      {com.CH_gui.gui.JSplitPaneVS.visualsClassKeyName+"_"+com.CH_gui.table.TableComponent.visualsClassKeyName+"_"+com.CH_gui.msgTable.MsgSentTableComponent.visualsClassKeyName+"_VS", "Divider location 201 -1 35 0"},
      {com.CH_gui.gui.JSplitPaneVS.visualsClassKeyName+"_"+com.CH_gui.table.TableComponent.visualsClassKeyName+"_"+com.CH_gui.msgTable.MsgSpamTableComponent.visualsClassKeyName+"_VS", "Divider location 201 -1 35 0"},
